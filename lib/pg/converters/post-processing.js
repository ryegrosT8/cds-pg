...
/**
 * Local version of '@sap/cds/libx/_runtime/common/utils/draft' with case insensitive regex
 * and Draft with dot instead of underline
 */
const ensureNoDraftsSuffix = (name) => name.replace(/_drafts$/gi, '').replace(/.drafts$/gi, '')
